//
//  SHVideoPlayerCustomControl.swift
//  SHVideoPlayer
//
...
public class SHVideoPlayerCustomControl: UIView {
    ...
    private func configurePlayButtonNormalStateImage() {
        _playButton.setImage(UIImage(named: "play"), for: UIControlState())
    }
    
    private func configureBackButtonImage() {
        _backButton.setImage(UIImage(named: "back"), for: .normal)
    }
    
    private func configurePlayButtonSelectedStateImage() {
        _playButton.setImage(UIImage(named: "pause"), for: .selected)
    }
    
    private func configureFullScreenButtonNormalStateImage() {
        _fullScreenButton.setImage(UIImage(named: "fullscreen"), for: .normal)
    }
...
extension SHVideoPlayerCustomControl: SHVideoPlayerControl {
    ...
    private func updateFullScreenImage() {
        _fullScreenButton.setImage(UIImage(named: "fullscreen"), for: UIControlState())
    }
    
    private func updateSmallScreenImage() {
        _fullScreenButton.setImage(UIImage(named: "smallscreen"), for: UIControlState())
    }
